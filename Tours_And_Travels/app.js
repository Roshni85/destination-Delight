...
// Add hotel
app.post("/add-hotel", isLoggedIn, isAdmin, wrapAsync(async (req, res) => {
...
app.get("/hotels", isLoggedIn, isAdmin, wrapAsync(async (req, res) => {
...
app.post("/customize-package", isLoggedIn, isAdmin, wrapAsync(async (req, res) => {
